	...
	return (
		<footer className="site-footer">
			...
			<div className="container footer-social" aria-label="Social links">
				<Link to="/explore" className="footer-link" aria-label="X">
				...
				<Link to="/explore" className="footer-link" aria-label="Facebook">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link" aria-label="YouTube">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link" aria-label="LinkedIn">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link" aria-label="Instagram">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link" aria-label="TikTok">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
			...
			<div className="container footer-bottom">
				<div className="footer-bottom-left">
					<p>© 2026 Coinbase</p>
					<p>•</p>
					<Link to="/explore" className="footer-link">Privacy</Link>
					<p>•</p>
					<Link to="/explore" className="footer-link">Terms & Conditions</Link>
				</div>
