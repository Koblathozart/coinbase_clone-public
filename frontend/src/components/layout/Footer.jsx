	...
	return (
		<footer className="site-footer">
			...
			<div className="container footer-social" aria-label="Social links">
				<Link to="/explore" className="footer-link-disabled" aria-label="X">
				...
				<Link to="/explore" className="footer-link-disabled" aria-label="Facebook">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link-disabled" aria-label="YouTube">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link-disabled" aria-label="LinkedIn">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link-disabled" aria-label="Instagram">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
				...
				<Link to="/explore" className="footer-link-disabled" aria-label="TikTok">
					<svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
			...
			<div className="container footer-bottom">
				<div className="footer-bottom-left">
					<p>© 2026 Coinbase</p>
					<p>•</p>
					<Link to="/explore" className="footer-link-disabled">Privacy</Link>
					<p>•</p>
					<Link to="/explore" className="footer-link-disabled">Terms & Conditions</Link>
				</div>
